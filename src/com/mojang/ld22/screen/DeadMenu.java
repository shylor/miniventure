...
public class DeadMenu extends Menu {
	...
	public void render(Screen screen) {
		...
		Font.draw("You lost!", screen, 2 * 8, 4 * 8, Color.get(-1, 555, 555, 555)); // Draws text
		...
		Font.draw("Press C to go to the Main Menu", screen, 2 * 8, 8 * 8, Color.get(-1, 333, 333, 333));//Draws text
	}
}
